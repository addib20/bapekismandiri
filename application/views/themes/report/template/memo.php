	...
	<body>
		<div id="header">
			<table>
				<tbody>
					<tr>
						<td><?php echo $no_memo ?></td>
						<td style="text-align: right;"><?php echo $nama_pic ?></td>
					</tr>
				</tbody>
			</table>
		</div>
		...
		<div>
			...
			<table class="list">
				...
				<tr>
					<td>CC</td>
					<td>:</td>
					<td>Direktorat Bisnis Mikro II</td>
				</tr>
				<tr>
					<td>Dari</td>
					<td>:</td>
				...
				<tr>
					<td>Tanggal</td>
					<td>:</td>
					<td><?php echo $this->datecalc->datepanjang($tgl_memo,'hbtin') ?></td>
				</tr>
				<tr>
					<td>Perihal</td>
					<td>:</td>
					<td>Usulan <?php echo $perihal_memo ?></td>
				</tr>
				<tr>
					<td>Lampiran</td>
					<td>:</td>
			...
			<table class="list">
				...
				<tr>
					<td>Tanggal</td>
					<td>:</td>
					<td><?php echo $this->datecalc->datepanjang($tgl_memo,'hbt') ?></td>
				</tr>
				<tr>
					<td>Perihal</td>
					<td>:</td>
			...
			<div style="text-align: justify; line-height: 1.5em;">
				Sehubungan dengan adanya rencana untuk melakukan training guna mendukung program yang telah dirancang oleh
				Divisi Pusat Pendidikan & Pelatihan di tahun 2014, kami merencanakan akan mengadakan kegiatan <strong><?php echo $tipe_kegiatan ?></strong> untuk <strong><?php echo preg_replace("/[^A-Za-z0-9 ]/", ' ', $sasaran); ?></strong>
				pada tanggal <strong><?php echo $penanggalan ?></strong>.
				<br />
				<br />
				Adapun kegiatan akan dilakukan di <strong><?php echo $tempat ?></strong> dengan jumlah peserta Pelatihan sebanyak <strong><?php echo $jml_peserta ?> orang</strong> (daftar terlampir)
				dan <strong><?php echo $jml_trainer ?> orang pengajar</strong> dengan <strong>total anggaran sebesar Rp. <?php echo number_format($rencana_biaya, 0, ',', '.'); ?></strong> dengan rincian biaya terlampir, biaya pelaksanaan kegiatan
				Pelatihan ini menjadi beban Divisi PPL.
				<br />
				<br />
				Demikian kami sampaikan. Atas perhatiannya dan bantuannya diucapkan terima kasih.
			</div>
			...
			<table class="signature_table">
				<tr><td><img class="media-object" alt="64x64" style="width: 150px; height: 100px;" src="<?php echo base_url().$ttd_app ?>"></td></tr>
				<tr><td><?php echo $nama_approve ?></td></tr>
				<tr><td><?php echo $jabatan_approve ?></td></tr>
			</table>
		</div>
		<hr/>
		<div>
			<?php if($sifat_kegiatan_id == 2): ?>
			<div id="section_header">Lembar Persetujuan Usulan</div>
			...
			<table class="list" border="1">
				...
				<tr>
					<td rowspan="2">Direktur Bisnis II</td>
					<td>CDN - Dirbis II</td>
					<td rowspan="2"></td>
				</tr>
				<tr>
		...
		<hr/>
		<div id="rundown"><?php echo $rundown ?></div>
		<hr/>
		<div id="biaya"><?php echo $biaya ?></div>
	</body>
</html>