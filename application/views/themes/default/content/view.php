                        ...
                        <div class="controls">
                        	<?php
                        		...
                        		if(!isset($field['type']) || $field['type']=='' || $field['type']=='input') {
									if(isset($field['view']) || $field['view']){
                        				echo '<label>'.$data_val[$field['name']].'</label>';
                        			}
									else {
								...
								elseif($field['type']=='upload_file') {
									if(!isset($field['view']) || $field['view']==''){
										...
										echo anchor('download/modul?id='.$data_val[$pk].'&tipe='.$field['name'], $file ,array('title'=>'Link Title'));
									}
								}
