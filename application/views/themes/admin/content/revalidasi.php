	...
	<div class="span12">
		<div class="box">
			...
			<div class="body" id="btn_tbl">
				<form class="form-horizontal" method="post" action="<?php echo base_url() ?>evaluasi/revalidasi/search" name="form_search_evaluasi" id="form_search_evaluasi" enctype="multipart/form-data">
